(function (global) {
    ...
    if (global.vendor && global.vendor.wp && global.vendor.wp.hooks) {
        ...
        var PROMO_MSG = '<div class="cfe-promo-notice" style="position:relative;padding:16px 40px 16px 16px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;color:#475569;font-size:13px;line-height:1.6;">' +
