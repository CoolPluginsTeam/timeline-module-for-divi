...
This is an add-on WordPress plugin for Divi Builder. It creates fantastic timeline using divi builder with few clicks.

This repo includes all the build scripts as well as source code (PHP/JSX/CSS)

This repo does not contains the node_module and it must be initialized in local machine before starting any further development.

use `npm i` or `npm install` to rebuild the node_module on local machine after cloning this repo.
...
[Ejecting](#yarn-eject) lets you customize anything, but from that point on you have to maintain the configuration and scripts yourself. This can be daunting if you have many similar projects. In such cases instead of ejecting we recommend to _fork_ `divi-scripts` and any other packages you need. [This article](https://auth0.com/blog/how-to-configure-create-react-app/) dives into how to do it in depth. You can find more discussion in [this issue](https://github.com/facebook/create-react-app/issues/682).
